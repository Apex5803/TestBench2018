 ...
 */
public class SwitchLeftFromLeft extends CommandGroup {
	SrxTrajectoryImporter importer = new SrxTrajectoryImporter("/home/lvuser/Autos");
	SrxTrajectory toFollow = null;
    public SwitchLeftFromLeft() {
        	try {
    			this.toFollow = importer.importSrxTrajectory("SwitchLeftFromLeft");
    			//System.out.println("import" + this.toFollow);
    			System.out.println("Running Autonomous Path: SwitchLeftFromLeft"); 
        	...
        	addSequential(new FollowTrajectory("SwitchLeftFromLeft"));
    }
}