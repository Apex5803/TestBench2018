 ...
 */
public class SwitchRightFromLeft extends CommandGroup {
	SrxTrajectoryImporter importer = new SrxTrajectoryImporter("/home/lvuser/Autos");
	SrxTrajectory toFollow = null;
    public SwitchRightFromLeft() {
        	try {
    			this.toFollow = importer.importSrxTrajectory("SwitchRightFromLeft");
    			//System.out.println("import" + this.toFollow);
    			System.out.println("Running Autonomous Path: SwitchRightFromLeft"); 
        	...
        	addSequential(new FollowTrajectory("SwitchRightFromLeft"));
    }
}